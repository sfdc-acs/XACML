...
public class GsonJsonResponseResult {
	...
	public Result toXacmlResult() {
	    ...
	    if (this.getPolicyIdentifierList() != null) {
	    	this.getPolicyIdentifierList().getPolicyIdReference().forEach(ref -> {
	    		xacmlResult.addPolicyIdentifier(ref.toXacml());
	    	});
	    	this.getPolicyIdentifierList().getPolicySetIdReference().forEach(ref -> {
	    		xacmlResult.addPolicySetIdentifier(ref.toXacml());
	    	});
	    }
